<x-layouts.admin>
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-blue-50 lg:text-3xl">Statistik Proyektor</h1>
                <p class="text-slate-600 dark:text-slate-400">Data real-time dari sistem proyektor terintegrasi.</p>
            </div>
            <div class="flex items-center gap-3">
                <button id="refresh-stats" class="px-4 py-2 text-sm font-medium bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-800 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3" id="stats-container">
            ...
            <div class="card-premium p-6 flex flex-col gap-4 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h3 id="total_proyektor" class="text-3xl font-bold text-slate-900 dark:text-white transition-all">...</h3>
                </div>
            ...
            <div class="card-premium p-6 flex flex-col gap-4 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h3 id="total_proyektor_rusak" class="text-3xl font-bold text-slate-900 dark:text-white transition-all">...</h3>
                </div>
            ...
            <div class="card-premium p-6 flex flex-col gap-4 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h3 id="total_pengguna" class="text-3xl font-bold text-slate-900 dark:text-white transition-all">...</h3>
                </div>
        ...
        <div id="error-message" class="hidden animate-fade-in">
            <div class="bg-rose-500/10 border border-rose-500/20 rounded-2xl p-6 flex flex-col items-center text-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400">Terjadi kesalahan saat mengambil statistik dari API. Pastikan sistem proyektor sedang online.</p>
                </div>
                <button onclick="fetchProjectorStats()" class="px-4 py-2 bg-rose-600 text-white rounded-xl hover:bg-rose-700 transition-all font-medium text-sm">Coba Lagi</button>
            </div>
        </div>
    </div>
