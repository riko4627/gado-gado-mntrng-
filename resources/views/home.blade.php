<x-layouts.app>
    <div class="relative min-h-screen bg-slate-50 dark:bg-background-dark text-slate-900 dark:text-white transition-colors duration-300">
        <!-- Floating Navigation -->
        <nav class="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl glass rounded-2xl px-6 py-4 flex items-center justify-between shadow-2xl shadow-blue-500/10 border border-white/20">
            ...
            <div class="flex items-center gap-4">
                <a href="/admin" class="px-5 py-2 text-sm font-bold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20">
                    Mulai Sekarang
                </a>
            </div>
        </nav>
        ...
        <section class="relative pt-40 pb-20 px-6 overflow-hidden">
            ...
            <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-gradient-to-b from-blue-500/10 to-transparent -z-10 blur-3xl"></div>
            
            <div class="max-w-6xl mx-auto text-center space-y-8 animate-fade-in">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 text-blue-600 text-xs font-bold border border-blue-500/20">
                ...
                <h1 class="text-4xl md:text-7xl font-extrabold tracking-tight leading-tight">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Presisi & Keindahan.</span>
                </h1>
                
                <p class="max-w-2xl mx-auto text-slate-500 dark:text-slate-400 text-lg md:text-xl">
                    Template Laravel premium dengan mode gelap, desain responsif, dan performa tinggi untuk membangun dashboard impian Anda dalam hitungan detik.
                </p>

                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                    <a href="/admin" class="w-full sm:w-auto px-8 py-4 bg-blue-600 text-white font-bold rounded-2xl hover:scale-105 transition-transform shadow-xl shadow-blue-500/25">
                        Lihat Dashboard Admin
                    </a>
                    <button class="w-full sm:w-auto px-8 py-4 glass text-slate-900 dark:text-white font-bold rounded-2xl hover:bg-white/20 transition-all border border-slate-200 dark:border-white/10">
                        Dokumentasi
                    </button>
                </div>
                ...
                <div class="relative mt-20 p-2 glass rounded-[2.5rem] shadow-3xl border border-white/20 group">
                    <div class="overflow-hidden rounded-[2rem] bg-slate-900 aspect-video relative">
                        <div class="absolute inset-0 bg-blue-600/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                            <span class="px-6 py-3 bg-white text-blue-600 rounded-full font-bold shadow-2xl">Pratinjau Live</span>
                        </div>
