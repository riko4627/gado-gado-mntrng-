<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-sidebar-bg text-sidebar-text transition-transform duration-300 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 shadow-2xl lg:shadow-none">
    <div class="flex flex-col h-full">
        <!-- Logo -->
        <div class="flex items-center justify-between h-16 px-6 bg-primary-light/30 border-b border-white/5">
            <div class="flex items-center gap-3">
                <div class="p-1.5 bg-blue-500 rounded-lg shadow-lg">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                    </svg>
                </div>
                <span class="text-lg font-bold tracking-tight">PLATFORM<span class="text-blue-400">X</span></span>
            </div>
